"""
Django settings for nufra_online project.
...
SECRET_KEY = 'django-insecure-qj=_pz(+=#kjnad$sgdcd417o3p*#%37-zz&fxvp-v+8*#feic'
...
ROOT_URLCONF = 'nufra_online.urls'
...
WSGI_APPLICATION = 'nufra_online.wsgi.application'
